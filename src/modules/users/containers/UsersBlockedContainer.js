...
const UsersBlockedContainer = ({getClientsListDispatch,getCountryListDispatch,entities,clients,isFetched,countries,totalPages,pageSize,pageNumber,getCardListDispatch,setTriggerListDispatch,cards}) => {
    const [filter, setFilter] = useState({status: "BLOCKED", searchingField: "",cardBrand:"",countryId:"",lastActiveDays:30,page:pageNumber,size:pageSize});
...
export default connect(mapStateToProps, mapDispatchToProps)(UsersBlockedContainer);
