...
const CancelledEventContainer = ({
    ...
    const resend = () => {
        setLoading(true);
        ApiService.ResendCancelledEvent(id).then((res) => {
            if (res && res.data) {
                setLoading(false);
            ...
            <Row>
                ...
                <Col xs={12} className={'mb-8'}>
                    <BaseBreadcrumb items={[{id: 1, name: 'Users', url: '/users'}, {
                        ...
                        name: 'Events',
                        url: '/users/events'
                    }, {id: 3, name: 'Cancelled', url: '/users/event/cancelled'}]}/>
                </Col>
                                ...
                                <Row>
                                    <Col xs={6}>
                                        <Flex justify={'space-between'}>
                                            ...
                                            <img src={get(event, 'photoUrl', '-')} className={'img-fluid'}
                                                 alt="Banner"/>
                                        </Flex>
                                        <hr className={'my-16'}/>
                                    </Col>
                            ...
                            <Col xs={12}>
                                <Row className={'mb-24'}>
                                    <Col xs={12} className={'text-center'}>
                                        <BaseButton success handleClick={() => resend()}>Resend event</BaseButton>
                                    </Col>
                                </Row>
                                <Row>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(CancelledEventContainer));
