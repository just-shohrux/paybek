...
const UsersInActiveContainer = ({getClientsListDispatch,getCountryListDispatch,entities,clients,isFetched,countries,totalPages,pageSize,pageNumber,getCardListDispatch,setTriggerListDispatch,cards}) => {
    const [filter, setFilter] = useState({status: "INACTIVE", searchingField: "",cardBrand:"",countryId:"",lastActiveDays:30,page:pageNumber,size:pageSize});
                        ...
                        <Row align={'center'} className={'mb-16'}>
                            <Col xs={9}>
                                <Flex>
                                    ...
                                    }))} options={[{value:10,label:'Last Active 10 days'},{value:30,label:'Last Active 30 days'},{value:60,label:'Last Active 60 days'},{value:90,label:'Last Active 90 days'},{value:10000,label:'All the time'}]} margin={'0 0 0 15px'} width={'250px'}
...
export default connect(mapStateToProps, mapDispatchToProps)(UsersInActiveContainer);
