...
const SuccessfulNotificationContainer = ({
                                      history,
                                      id,
                                      entities,
                                      notification,
        ...
        <Container fluid>
            <Row>
                ...
                <Col xs={12} className={'mb-8'}>
                    ...
                    }, {id: 3, name: 'Successful', url: '/users/notification/success'}]}/>
                </Col>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(SuccessfulNotificationContainer));
