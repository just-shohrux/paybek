...
const TxnsRefundedContainer = ({
    ...
    const [filter, setFilter] = useState({  txnStatusEnum: "REFUNDED",countryId: "", fromDate:moment('2021-09-01').format("YYYY-MM-DD"),toDate:moment().add(1,'days').format("YYYY-MM-DD"),searchingField: "", size: pageSize, page: pageNumber});
        ...
        <Container fluid>
            <Row>
                ...
                <Col xs={12} className={'mb-8'}>
                    <BaseBreadcrumb items={[{id: 1, name: 'TXNS', url: '/txns'},{id: 2, name: 'Refunded', url: '/txns/refunded'}]}/>
                </Col>
                <Col xs={12}>
                    <Content>
                                ...
                                {isFetched ?
                                    <BaseTable
                                        ...
                                        {!isEmpty(txns) ? txns.map((item, index) => <tr key={get(item, 'id', null)}>
                                            ...
                                            <td><ReactSVG src={refundedIcon} /></td>
                                        </tr>) : <tr>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(TxnsRefundedContainer));
